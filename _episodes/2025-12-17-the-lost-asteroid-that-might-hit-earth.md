---
layout: episode
title: "The 'Lost' Asteroid That Might Hit Earth"
episode_number: 11
season_number: 3
date: 2025-12-17
...
duration: "PT36M55S"
description: >
  Join us as we explore humanity's ongoing game of cosmic hide-and-seek with near-Earth asteroids—from the "lost" 2007 FT3 that was observed for just 1.2 days before vanishing into the void, to the football-field-sized 2019 OK that arrived with same-day notice. From Darren's futile attempts to get the Department of Celestial Asset Tracking to take eighty-nine potential impact scenarios seriously, to the real science behind how we've gone from "complete surprise" to "global detection network," we examine what happens when a species realizes it needs to watch the sky—and then actually starts doing it.
---
