---
layout: episode
title: "The End of the ISS (and What Comes After)"
episode_number: 12
season_number: 3
date: 2025-12-23
...
duration: "PT48M21S"
description: >
  Join us as we explore the scheduled retirement of humanity's most ambitious flatshare—the International Space Station. From Dax Rincewind's napkin-based proposal to crash it into Greenland ("$800 billion opportunity!") to the real science of controlled deorbit, we examine what happens when twenty-five years of international cooperation ends with paperwork, contracts, and a one-way trip to Point Nemo. Plus: why commercial space stations might not be ready in time, what Russia plans to do with its contaminated modules, and whether low Earth orbit is about to become a business park.
---
